...
<body>
	<div class="container myflex">
		<div class="nav flex-column nav-pills menubar mt-5 menuDiv"
			...
			<a class="nav-link active" id="v-pills-home-tab" data-toggle="pill"
				...
				data-toggle="pill" href="subadminmaster.jsp" role="tab"
				aria-controls="v-pills-messages" aria-selected="false">SubAdmin Master</a>
		...
		<div class="divContent mt-5">
			<ul class="bg-primary">
				<li><a href='newadmin.jsp'>Add New Sub Admin</a>
				<li><a href='viewadmin.jsp'>View Sub Admin</a>
			</ul>
</body>
</html>